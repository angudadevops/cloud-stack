<h1>Cloud Native Core v3.1 (formely EGX Stack 3.1) - Install Guide for Ubuntu Server x86-64</h1>
<h2>Introduction</h2>
...
Now execute the below command to install MULTUS CNI Plugin on Cloud Native Core from the master node
