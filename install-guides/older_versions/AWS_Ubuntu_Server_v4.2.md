<h1>Cloud Native Core v4.2(formely EGX Stack 4.2) for AWS - Install Guide for Ubuntu Server x86-64</h1>
<h2>Introduction</h2>
This document describes setting up NVIDIA Cloud Native Core v4.12 on one or multiple GPU accelerated AWS instances to deploy AI applications via Helm charts from NVIDIA NGC. Cloud Native Core v4.2 will include:
