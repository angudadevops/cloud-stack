<h1>Cloud Native Core - v6.0 Install Guide for Jetson AGX Xavier or Jetson Xavier NX DevKit</h1>
...
- Upgraded to NVIDIA Container Runtime 3.8.0-1
...
```
 wget https://github.com/containerd/containerd/releases/download/v1.6.0/cri-containerd-cni-1.6.0-linux-arm64.tar.gz
 sudo tar --no-overwrite-dir -C / -xzf cri-containerd-cni-1.6.0-linux-arm64.tar.gz
 rm -rf cri-containerd-cni-1.6.0-linux-arm64.tar.gz
```
