<h1>Cloud Native Core - v4.0(formely EGX Stack 4.0) Install Guide for Jetson Xavier NX DevKit</h1>

<h2>Introduction</h2>

This document describes how to set up Cloud Native Core Version 4.0 on a Jetson Xavier NX DevKit to deploy AI applications via Helm charts from NGC. 
