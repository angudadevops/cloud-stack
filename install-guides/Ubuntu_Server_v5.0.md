<h1>Cloud Native Core v5.0 - Install Guide for Ubuntu Server x86-64</h1>
<h2>Introduction</h2>
...
- Upgraded to Ubuntu 20.04.3
- Upgraded to Containerd 1.4.9
- Upgraded to Kubernetes 1.22.5
- Upgraded to Helm 3.6.2
- Upgraded to NVIDIA GPU Operator 1.9.1
- Upgraded to NVIDIA Network Operator 1.1.0
...
To determine if your system qualifies as an NVIDIA Certified System or an NGC-Ready Server, review the list of NVIDIA Certified Systems [here](https://docs.nvidia.com/ngc/ngc-deploy-on-premises/nvidia-certified-systems/index.html). 
...
```
 helm install --version 1.9.1 --create-namespace --namespace gpu-operator-resources nvidia/gpu-operator --set driver.version=470.103.01 --wait --generate-name
```
...
```
 helm install --version 1.9.1 --create-namespace --namespace gpu-operator-resources nvidia/gpu-operator  --set driver.rdma.enabled=true --set driver.version=470.103.01 --wait --generate-name
```
...
```
 helm install --version 1.9.1 --create-namespace --namespace gpu-operator-resources nvidia/gpu-operator --set driver.rdma.enabled=true,driver.rdma.useHostMofed=true --set driver.version=470.103.01 --wait --generate-name 
